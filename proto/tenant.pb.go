...
type TenantInfo struct {
	...
	TenantMenus  []*TenantMenu      `protobuf:"bytes,14,rep,name=tenantMenus,proto3" json:"tenantMenus,omitempty"`
	Certificate  *TenantCertificate `protobuf:"bytes,15,opt,name=certificate,proto3" json:"certificate,omitempty"`
	UserCount    int32              `protobuf:"varint,16,opt,name=userCount,proto3" json:"userCount,omitempty"`
	RoleCount    int32              `protobuf:"varint,17,opt,name=roleCount,proto3" json:"roleCount,omitempty"`
	ProjectCount int32              `protobuf:"varint,18,opt,name=projectCount,proto3" json:"projectCount,omitempty"`
	Expired      string             `protobuf:"bytes,19,opt,name=expired,proto3" json:"expired,omitempty"`
	// 系统必须要有的数据
	IsMust bool `protobuf:"varint,20,opt,name=isMust,proto3" json:"isMust,omitempty"`
}
...
type QueryTenantRequest struct {
	...
	IsMust bool `protobuf:"varint,11,opt,name=isMust,proto3" json:"isMust,omitempty"`
	// @inject_tag: uri:"sortConfig" form:"sortConfig"
	SortConfig string `protobuf:"bytes,12,opt,name=sortConfig,proto3" json:"sortConfig,omitempty"`
}
