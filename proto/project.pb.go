...
type ProjectInfo struct {
	...
	FormCount      int32                   `protobuf:"varint,4,opt,name=formCount,proto3" json:"formCount,omitempty"`
	PageCount      int32                   `protobuf:"varint,5,opt,name=pageCount,proto3" json:"pageCount,omitempty"`
	Expired        string                  `protobuf:"bytes,6,opt,name=expired,proto3" json:"expired,omitempty"`
	Description    string                  `protobuf:"bytes,7,opt,name=description,proto3" json:"description,omitempty"`
	CellCount      int32                   `protobuf:"varint,8,opt,name=cellCount,proto3" json:"cellCount,omitempty"`
	FormComponents []*ProjectFormComponent `protobuf:"bytes,9,rep,name=formComponents,proto3" json:"formComponents,omitempty"`
	// 系统必须要有的数据
...
type QueryProjectRequest struct {
	...
	SortConfig string `protobuf:"bytes,8,opt,name=sortConfig,proto3" json:"sortConfig,omitempty"`
...
type QueryProjectResponse struct {
	...
	Data    []*ProjectInfo `protobuf:"bytes,3,rep,name=data,proto3" json:"data,omitempty"`
...
type GetProjectDetailResponse struct {
	...
	Code    Code         `protobuf:"varint,1,opt,name=code,proto3,enum=usercenter.Code" json:"code,omitempty"`
	Message string       `protobuf:"bytes,2,opt,name=message,proto3" json:"message,omitempty"`
	Data    *ProjectInfo `protobuf:"bytes,3,opt,name=data,proto3" json:"data,omitempty"`
}
