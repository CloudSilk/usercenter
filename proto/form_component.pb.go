...
type FormComponentInfo struct {
	...
	Extends         string                 `protobuf:"bytes,6,opt,name=extends,proto3" json:"extends,omitempty"`
	Selector        string                 `protobuf:"bytes,7,opt,name=selector,proto3" json:"selector,omitempty"`
	DesignerProps   string                 `protobuf:"bytes,8,opt,name=designerProps,proto3" json:"designerProps,omitempty"`
	DesignerLocales string                 `protobuf:"bytes,9,opt,name=designerLocales,proto3" json:"designerLocales,omitempty"`
	Resource        *FormComponentResource `protobuf:"bytes,10,opt,name=resource,proto3" json:"resource,omitempty"`
	Title           string                 `protobuf:"bytes,11,opt,name=title,proto3" json:"title,omitempty"`
	Byo             bool                   `protobuf:"varint,12,opt,name=byo,proto3" json:"byo,omitempty"`
}
...
type FormComponentResource struct {
	...
	Id              string `protobuf:"bytes,1,opt,name=id,proto3" json:"id,omitempty"`
	FormComponentID string `protobuf:"bytes,2,opt,name=formComponentID,proto3" json:"formComponentID,omitempty"`
	Icon            string `protobuf:"bytes,3,opt,name=icon,proto3" json:"icon,omitempty"`
	Thumb           string `protobuf:"bytes,4,opt,name=thumb,proto3" json:"thumb,omitempty"`
	Title           string `protobuf:"bytes,5,opt,name=title,proto3" json:"title,omitempty"`
	Description     string `protobuf:"bytes,6,opt,name=description,proto3" json:"description,omitempty"`
	Span            int32  `protobuf:"varint,7,opt,name=span,proto3" json:"span,omitempty"`
	Elements        string `protobuf:"bytes,8,opt,name=elements,proto3" json:"elements,omitempty"`
}
...
type QueryFormComponentResponse struct {
	...
	Data    []*FormComponentInfo `protobuf:"bytes,3,rep,name=data,proto3" json:"data,omitempty"`
...
type GetFormComponentDetailResponse struct {
	...
	Code    Code               `protobuf:"varint,1,opt,name=code,proto3,enum=usercenter.Code" json:"code,omitempty"`
	Message string             `protobuf:"bytes,2,opt,name=message,proto3" json:"message,omitempty"`
	Data    *FormComponentInfo `protobuf:"bytes,3,opt,name=data,proto3" json:"data,omitempty"`
}
