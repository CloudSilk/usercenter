...
type DictionariesInfo struct {
	...
	// 系统必须要有的数据
	IsMust bool `protobuf:"varint,8,opt,name=isMust,proto3" json:"isMust,omitempty"`
}
...
type QueryDictionariesResponse struct {
	...
	Data    []*DictionariesInfo `protobuf:"bytes,3,rep,name=data,proto3" json:"data,omitempty"`
...
type GetDictionariesDetailResponse struct {
	...
	Code    Code              `protobuf:"varint,1,opt,name=code,proto3,enum=usercenter.Code" json:"code,omitempty"`
	Message string            `protobuf:"bytes,2,opt,name=message,proto3" json:"message,omitempty"`
	Data    *DictionariesInfo `protobuf:"bytes,3,opt,name=data,proto3" json:"data,omitempty"`
}
