...
type CurrentUser struct {
	...
	IsVip      bool   `protobuf:"varint,15,opt,name=isVip,proto3" json:"isVip,omitempty"`
	VipExpired int64  `protobuf:"varint,16,opt,name=vipExpired,proto3" json:"vipExpired,omitempty"`
}
