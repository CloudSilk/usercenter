...
type LoginByStaffNoRequest struct {
	...
	StaffNo  string `protobuf:"bytes,3,opt,name=staffNo,proto3" json:"staffNo,omitempty"`
}
...
type GetBasicsResponse struct {
	...
	Code    Code        `protobuf:"varint,1,opt,name=code,proto3,enum=usercenter.Code" json:"code,omitempty"`
	Message string      `protobuf:"bytes,2,opt,name=message,proto3" json:"message,omitempty"`
	Data    *BasicsInfo `protobuf:"bytes,3,opt,name=data,proto3" json:"data,omitempty"`
}
...
type UserProfile struct {
	...
	ChineseName string `protobuf:"bytes,21,opt,name=chineseName,proto3" json:"chineseName,omitempty"`
	EnglishName string `protobuf:"bytes,22,opt,name=englishName,proto3" json:"englishName,omitempty"`
	StaffNo     string `protobuf:"bytes,23,opt,name=staffNo,proto3" json:"staffNo,omitempty"`
	IsVip       bool   `protobuf:"varint,24,opt,name=isVip,proto3" json:"isVip,omitempty"`
	VipExpired  string `protobuf:"bytes,25,opt,name=vipExpired,proto3" json:"vipExpired,omitempty"`
}
...
type UserInfo struct {
	...
	ProjectID      string `protobuf:"bytes,27,opt,name=projectID,proto3" json:"projectID,omitempty"`
	WechatConfigID string `protobuf:"bytes,28,opt,name=wechatConfigID,proto3" json:"wechatConfigID,omitempty"`
	// 系统必须要有的数据
	IsMust           bool                   `protobuf:"varint,29,opt,name=isMust,proto3" json:"isMust,omitempty"`
	WechatOpenIDMaps []*UserWechatOpenIDMap `protobuf:"bytes,30,rep,name=wechatOpenIDMaps,proto3" json:"wechatOpenIDMaps,omitempty"`
	Age              int32                  `protobuf:"varint,31,opt,name=age,proto3" json:"age,omitempty"`
	Height           float32                `protobuf:"fixed32,32,opt,name=height,proto3" json:"height,omitempty"`
	Weight           float32                `protobuf:"fixed32,33,opt,name=weight,proto3" json:"weight,omitempty"`
	IsVip            bool                   `protobuf:"varint,34,opt,name=isVip,proto3" json:"isVip,omitempty"`
	VipExpired       string                 `protobuf:"bytes,35,opt,name=vipExpired,proto3" json:"vipExpired,omitempty"`
}
...
type UserWechatOpenIDMap struct {
	...
	WechatConfigID string `protobuf:"bytes,5,opt,name=wechatConfigID,proto3" json:"wechatConfigID,omitempty"`
}
...
type QueryUserRequest struct {
	...
	WechatConfigID string `protobuf:"bytes,17,opt,name=wechatConfigID,proto3" json:"wechatConfigID,omitempty"`
	// @inject_tag: uri:"isMust" form:"isMust"
	IsMust bool `protobuf:"varint,18,opt,name=isMust,proto3" json:"isMust,omitempty"`
	// @inject_tag: uri:"sortConfig" form:"sortConfig"
	SortConfig string `protobuf:"bytes,19,opt,name=sortConfig,proto3" json:"sortConfig,omitempty"`
}
...
type ChangePwdRequest struct {
	...
	// @inject_tag: validate:"required"
	NewConfirmPwd string `protobuf:"bytes,5,opt,name=newConfirmPwd,proto3" json:"newConfirmPwd,omitempty"`
}
