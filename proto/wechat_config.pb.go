...
type WechatConfigInfo struct {
	...
	DefaultRoleID string `protobuf:"bytes,7,opt,name=defaultRoleID,proto3" json:"defaultRoleID,omitempty"`
	// 重定向URL
	RedirectUrl string `protobuf:"bytes,8,opt,name=redirectUrl,proto3" json:"redirectUrl,omitempty"`
	// Token
	Token string `protobuf:"bytes,9,opt,name=token,proto3" json:"token,omitempty"`
	// 消息加解密密钥
	EncodingAESKey string `protobuf:"bytes,10,opt,name=encodingAESKey,proto3" json:"encodingAESKey,omitempty"`
	// 消息加解密方式,1-明文模式,2-兼容模式,3-安全模式（推荐）
	EncodingMethod int32 `protobuf:"varint,11,opt,name=encodingMethod,proto3" json:"encodingMethod,omitempty"`
	// 显示名称
	...
	// 系统必须要有的数据
	IsMust  bool   `protobuf:"varint,14,opt,name=isMust,proto3" json:"isMust,omitempty"`
	AgentID string `protobuf:"bytes,15,opt,name=agentID,proto3" json:"agentID,omitempty"`
}
...
func (x *WechatConfigInfo) GetAgentID() string {
	if x != nil {
		return x.AgentID
	}
	return ""
...
type QueryWechatConfigRequest struct {
	...
	AppType int32 `protobuf:"varint,9,opt,name=appType,proto3" json:"appType,omitempty"`
...
type QueryWechatConfigResponse struct {
	...
	Data    []*WechatConfigInfo `protobuf:"bytes,3,rep,name=data,proto3" json:"data,omitempty"`
...
type GetWechatConfigDetailResponse struct {
	...
	Code    Code              `protobuf:"varint,1,opt,name=code,proto3,enum=usercenter.Code" json:"code,omitempty"`
	Message string            `protobuf:"bytes,2,opt,name=message,proto3" json:"message,omitempty"`
	Data    *WechatConfigInfo `protobuf:"bytes,3,opt,name=data,proto3" json:"data,omitempty"`
}
...
var file_wechat_config_proto_rawDesc = []byte{
	...
	0xc0, 0x03, 0x0a, 0x10, 0x57, 0x65, 0x63, 0x68, 0x61, 0x74, 0x43, 0x6f, 0x6e, 0x66, 0x69, 0x67,
	...
	0x52, 0x06, 0x69, 0x73, 0x4d, 0x75, 0x73, 0x74, 0x12, 0x18, 0x0a, 0x07, 0x61, 0x67, 0x65, 0x6e,
	0x74, 0x49, 0x44, 0x18, 0x0f, 0x20, 0x01, 0x28, 0x09, 0x52, 0x07, 0x61, 0x67, 0x65, 0x6e, 0x74,
	0x49, 0x44, 0x22, 0x90, 0x02, 0x0a, 0x18, 0x51, 0x75, 0x65, 0x72, 0x79, 0x57, 0x65, 0x63, 0x68,
	...
	,
	...
	0x0b, 0x32, 0x1c, 0x2e, 0x75, 0x73, 0x65, 0x72, 0x63, 0x65, 0x6e, 0x74, 0x65, 0x72, 0x2e, 0x57,
	0x65, 0x63, 0x68, 0x61, 0x74, 0x43, 0x6f, 0x6e, 0x66, 0x69, 0x67, 0x49, 0x6e, 0x66, 0x6f, 0x52,
	...
	0x20, 0x01, 0x28, 0x03, 0x52, 0x05, 0x74, 0x6f, 0x74, 0x61, 0x6c, 0x22, 0x8e, 0x01, 0x0a, 0x1a,
	0x47, 0x65, 0x74, 0x41, 0x6c, 0x6c, 0x57, 0x65, 0x63, 0x68, 0x61, 0x74, 0x43, 0x6f, 0x6e, 0x66,
	0x69, 0x67, 0x52, 0x65, 0x73, 0x70, 0x6f, 0x6e, 0x73, 0x65, 0x12, 0x24, 0x0a, 0x04, 0x63, 0x6f,
	...
	0x74, 0x61, 0x18, 0x03, 0x20, 0x03, 0x28, 0x0b, 0x32, 0x1c, 0x2e, 0x75, 0x73, 0x65, 0x72, 0x63,
	0x65, 0x6e, 0x74, 0x65, 0x72, 0x2e, 0x57, 0x65, 0x63, 0x68, 0x61, 0x74, 0x43, 0x6f, 0x6e, 0x66,
	0x69, 0x67, 0x49, 0x6e, 0x66, 0x6f, 0x52, 0x04, 0x64, 0x61, 0x74, 0x61, 0x22, 0x91, 0x01, 0x0a,
	0x1d, 0x47, 0x65, 0x74, 0x57, 0x65, 0x63, 0x68, 0x61, 0x74, 0x43, 0x6f, 0x6e, 0x66, 0x69, 0x67,
	...
	,
	...
	0x65, 0x72, 0x79, 0x12, 0x24, 0x2e, 0x75, 0x73, 0x65, 0x72, 0x63, 0x65, 0x6e, 0x74, 0x65, 0x72,
	0x2e, 0x51, 0x75, 0x65, 0x72, 0x79, 0x57, 0x65, 0x63, 0x68, 0x61, 0x74, 0x43, 0x6f, 0x6e, 0x66,
	0x69, 0x67, 0x52, 0x65, 0x71, 0x75, 0x65, 0x73, 0x74, 0x1a, 0x25, 0x2e, 0x75, 0x73, 0x65, 0x72,
	...
	,
