...
type LanguageInfo struct {
	...
	// Japan
	Japan string `protobuf:"bytes,6,opt,name=japan,proto3" json:"japan,omitempty"`
	// Name
	Name string `protobuf:"bytes,7,opt,name=name,proto3" json:"name,omitempty"`
	// System Admin-管理后台 APP
	System string `protobuf:"bytes,8,opt,name=system,proto3" json:"system,omitempty"`
	// 所属站点
	WebSiteID string `protobuf:"bytes,9,opt,name=webSiteID,proto3" json:"webSiteID,omitempty"`
	...
	// 系统必须要有的数据
	IsMust bool `protobuf:"varint,12,opt,name=isMust,proto3" json:"isMust,omitempty"`
}
...
type QueryLanguageRequest struct {
	...
	SortConfig string `protobuf:"bytes,7,opt,name=sortConfig,proto3" json:"sortConfig,omitempty"`
}
...
type QueryLanguageResponse struct {
	...
	Data    []*LanguageInfo `protobuf:"bytes,3,rep,name=data,proto3" json:"data,omitempty"`
...
type GetLanguageDetailResponse struct {
	...
	Code    Code          `protobuf:"varint,1,opt,name=code,proto3,enum=usercenter.Code" json:"code,omitempty"`
	Message string        `protobuf:"bytes,2,opt,name=message,proto3" json:"message,omitempty"`
	Data    *LanguageInfo `protobuf:"bytes,3,opt,name=data,proto3" json:"data,omitempty"`
}
